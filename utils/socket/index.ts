...
export type TListenEventCallbackMap = {
  ...
  [SocketEvents.AddUser]: (data: { id: string; data: EmployeeFullDto }) => void;
  [SocketEvents.UpdateUser]: (data: {
    id: string;
    data: EmployeeFullDto;
  }) => void;
  [SocketEvents.DeleteUser]: (data: string) => void;
  [SocketEvents.AddGroup]: (data: { id: string; data: GroupDto }) => void;
  [SocketEvents.UpdateGroup]: (data: { id: string; data: GroupDto }) => void;
  [SocketEvents.AddGuest]: (data: {
    id: string;
    data: EmployeeFullDto;
  }) => void;
  [SocketEvents.UpdateGuest]: (data: {
    id: string;
    data: EmployeeFullDto;
  }) => void;
...
class SocketHelper {
   ...
   */
  public connect(url: string, publicRoomKey: string, authToken?: string) {
    if (!url) return;
