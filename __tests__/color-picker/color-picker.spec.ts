...
// → prefix: "ui-interactive-elements-colorpicker"
const STORY_BASE = "ui-interactive-elements-colorpicker";
...
test.describe("ColorPicker — dark", () => {
  ...
  test("css customization dark", async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot("color-picker-css-customization-dark.png");
  });
});
