...
import { AccountsSearchArea } from "../../enums";
import { EmployeeStatus, type EmployeeFullDto, type GroupDto } from "@onlyoffice/docspace-api-sdk";
...
const PeopleSelector = ({
	...
	const headerSelectorProps: TSelectorHeader = withHeader
		? {
				...
				headerProps: {
					...headerProps,
					headerLabel: headerProps.headerLabel || getCommonTranslation("Contacts"),
				},
			}
		: ({} as TSelectorHeader);
	...
	return (
		<Selector
			...
			items={itemsList}
			submitButtonLabel={submitButtonLabel || getCommonTranslation("SelectAction")}
			onSubmit={onSubmit}
