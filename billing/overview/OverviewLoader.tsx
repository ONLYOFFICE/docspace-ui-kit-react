...
const HeaderLoader = ({
  ...
  <div className={styles.cardHeader}>
    <RectangleSkeleton
      uniqueKey={`${uniqueKey}-title`}
      width={titleWidth}
      height="14px"
      borderRadius={R}
    />
    <RectangleSkeleton
      uniqueKey={`${uniqueKey}-link`}
      width="60px"
      height="14px"
      borderRadius={R}
    />
  ...
  <div className={styles.card}>
    ...
    <div className={styles.rows}>
      <div className={styles.row}>
        <RectangleSkeleton
          uniqueKey={`${uniqueKey}-r1l`}
          width="170px"
          height="16px"
          borderRadius={R}
        />
        <RectangleSkeleton
          uniqueKey={`${uniqueKey}-r1r`}
          width="65px"
          height="20px"
          borderRadius={R}
        />
      ...
      <div className={styles.row}>
        <RectangleSkeleton
          uniqueKey={`${uniqueKey}-r2l`}
          width="103px"
          height="16px"
          borderRadius={R}
        />
        <RectangleSkeleton
          uniqueKey={`${uniqueKey}-r2r`}
          width="78px"
          height="20px"
          borderRadius={R}
        />
      ...
      <div className={styles.row}>
        <RectangleSkeleton
          uniqueKey={`${uniqueKey}-r3l`}
          width="139px"
          height="16px"
          borderRadius={R}
        />
        <RectangleSkeleton
          uniqueKey={`${uniqueKey}-r3r`}
          width="46px"
          height="20px"
          borderRadius={R}
        />
    ...
    <div className={loaderStyles.loader}>
      ...
      <div className={`${styles.card} ${styles.creditsCard}`}>
        <div className={styles.creditsTop}>
          <div className={loaderStyles.creditsLeft}>
            <RectangleSkeleton
              uniqueKey="ov-credits-title"
              width="132px"
              height="14px"
              borderRadius={R}
            />
            <RectangleSkeleton
              uniqueKey="ov-credits-amount"
              width="180px"
              height="28px"
              borderRadius={R}
            />
      ...
      <div className={`${styles.card} ${styles.planCard}`}>
        <div className={styles.planInfo}>
          <RectangleSkeleton
            uniqueKey="ov-plan-title"
            width="80px"
            height="14px"
            borderRadius={R}
          />
          <RectangleSkeleton
            uniqueKey="ov-plan-name"
            width="96px"
            height="20px"
            borderRadius={R}
          />
          <RectangleSkeleton
            uniqueKey="ov-plan-text"
            width="200px"
            height="14px"
            borderRadius={R}
          />
      ...
      <div className={styles.grid2}>
        ...
        <div className={styles.card}>
          ...
          <div className={`${styles.rows} ${styles.cardBody}`}>
            <RowLoader
              uniqueKey="ov-payment-1"
              left="180px"
              right="40px"
              icon
            />
            <RowLoader
              uniqueKey="ov-payment-2"
              left="160px"
              right="40px"
              icon
            />
