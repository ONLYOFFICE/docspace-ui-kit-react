...
const ChatScrollContext = createContext<ChatScrollContextType | undefined>(undefined);
...
export type ChatScrollProviderProps = {
  children: React.ReactNode;
  useExternalScroll: boolean;
  scrollbarRef: React.RefObject<HTMLElement | null>;
};

export const ChatScrollProvider: React.FC<ChatScrollProviderProps> = ({
  children,
  useExternalScroll,
  scrollbarRef,
}) => {
  const value = useMemo(
    ...
    [useExternalScroll, scrollbarRef]
  );
