...
_Generated by `pnpm readme:props` from `ModalDialog.types.ts`. Do not edit; edit the JSDoc._

| Prop                     | Type                                                   | Required | Default                             | Description                                                                                       |
| ------------------------ | ------------------------------------------------------ | -------- | ----------------------------------- | ------------------------------------------------------------------------------------------------- |
| `children`               | `(React.ReactElement \| null)[] \| React.ReactElement` | **yes**  | –                                   | Displays the child elements                                                                       |
...
| `dataTestId`             | `string`                                               | no       | `"modal"`                           | Test id                                                                                           |
...
| `modalSwipeOffset`       | `number`                                               | no       | –                                   | Offset for modal swipe animation. Internal: the component computes its own and yours replaces it. |
...
| `withFooterBorder`       | `boolean`                                              | no       | `true` for aside, `false` for modal | **`MODAL-ONLY`** Displays border between body and footer                                          |
...
The header slot is the same header [`Aside`](../aside/README.md) uses, so its props are
accepted here too.

| Prop              | Type                                                                               | Required | Default | Description                                     |
| ----------------- | ---------------------------------------------------------------------------------- | -------- | ------- | ----------------------------------------------- |
| `header`          | `string \| React.ReactNode`                                                        | no       | –       | Header content - can be a string or a ReactNode |
| `headerComponent` | `React.ReactNode`                                                                  | no       | –       | Additional component to render in the header    |
| `headerHeight`    | `string`                                                                           | no       | –       | Custom height for the header                    |
| `headerIcons`     | `{ key: string; url?: string; iconNode?: React.ReactNode; onClick: () => void }[]` | no       | –       | Array of icons to display in the header         |
