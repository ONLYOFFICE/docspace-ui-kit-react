...
import ClearReactSvgUrl from "../../../assets/icons/17/clear.react.svg";

import { FilterBlockLoader } from "../skeletons/FilterBlockLoader";
...
const FilterBlock = ({
  ...
  return (
    ...
    >
      {showSelector.show && renderSelector ? (
