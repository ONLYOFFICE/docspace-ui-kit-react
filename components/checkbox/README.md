...
| `tabIndex`        | `number`                                              | no       | `0`          | Applied to the checkbox's **icon**, which is the focusable element — the input beneath it is always `-1`. Pass `-1` for a checkbox the keyboard is meant to skip.                                    |
